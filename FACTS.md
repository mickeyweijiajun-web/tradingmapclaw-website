...
Version: v2.0.1
As-of: 2026-07-13 (Asia/Shanghai)
Owner: Mickey Wei
...
| 事实 | 值 |
|---|---|
| 定时任务 (scheduled workflows) | 118 total / 117 enabled |
| Python 脚本 | 230+ |
| SKILL.md 模块 | 50+ |
...
| 产品 | 价格 | 状态 (2026-07-13) |
|---|---|---|
| Tutorial 01 — Dual-Engine Verification | $19 | 文件已完成；Payhip 未上架 → 网站 CTA = waitlist/PreOrder |
| Tutorial 02 — Cron Recovery & Self-Heal | $19 | 同上 |
| Tutorial 03 — Budget Watchdog | $19 | 同上 |
| Complete Bundle (3 tutorials) | $49 | 同上 |
| Patterns Bundle (7 skill packs) | $79 | 同上 |
...
- Payhip 上架完成前：不得写 "Buy now available"；JSON-LD availability = PreOrder。
